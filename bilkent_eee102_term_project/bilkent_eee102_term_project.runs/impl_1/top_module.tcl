...
set rc [catch {
  ...
  add_files -quiet /home/battal/vivado/bilkent_eee102_term_project/bilkent_eee102_term_project.runs/synth_1/top_module.dcp
...
set rc [catch {
  ...
  catch {file copy -force debug_nets.ltx top_module.ltx}
